...
mesh.add_component(LoadMesh(GL_TRIANGLES, "../models/Monkey.obj"))

leaf = Object("Leaf")
leaf.add_component(Transform((1, 0, -3)))
leaf.add_component(LoadMesh(GL_TRIANGLES, "../models/teapot.obj"))

objects_3d.append(cube)
objects_3d.append(mesh)
objects_3d.append(leaf)

# Load the mesh without specifying back face culling
mesh_component = LoadMesh(GL_TRIANGLES, "../models/Monkey.obj")

# Enable back face culling using OpenGL after loading the mesh
glEnable(GL_CULL_FACE)
glCullFace(GL_BACK)

mesh.add_component(mesh_component)
